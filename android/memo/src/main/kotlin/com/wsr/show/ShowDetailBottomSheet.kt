...
@Composable
internal fun ShowDetailBottomSheet(
    uiState: ShowDetailBottomSheetUiState,
    listener: ShowDetailBottomSheetListener,
) {
...
internal data class ShowDetailBottomSheetListener(
    val onDismiss: () -> Unit,
